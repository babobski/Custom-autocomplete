...
const CLASS_ID = Components.ID("3ab2c9b9-93c9-486f-9dad-37a8dbade57f"); // ← Change this
const CLASS_NAME = "Factif AutoComplete";
const CONTRACT_ID = "@mozilla.org/autocomplete/search;1?name=factif-autocomplete";
